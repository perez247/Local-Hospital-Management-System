...
using Application.Command.UserEntities.ChangePassword;
using Application.Command.UserEntities.ResetPassword;
...
namespace ChannelClinic.Controllers
{
    ...
    public class AuthController : BaseController
    {
        ...
        {
            //command.SetCurrentUserRequest(ApplicationUserRequest);
            await UpdateToken(command, nameof(ChangePasswordCommand));
            var result = await ApplicationUserRequest?.Mediator?.Send(command);
        ...
        public async Task<IActionResult> RessetPassword([FromBody] ResetPasswordCommand command)
        {
            //command.SetCurrentUserRequest(ApplicationUserRequest);
            await UpdateToken(command, nameof(ResetPasswordCommand));
            var result = await ApplicationUserRequest?.Mediator?.Send(command);
