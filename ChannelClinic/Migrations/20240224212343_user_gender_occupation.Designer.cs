...
namespace ChannelClinic.Migrations
{
    ...
    [Migration("20240224212343_user_gender_occupation")]
    partial class user_gender_occupation
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Models.MonthlyFinanceRecord", b =>
                {
                    b.Property<Guid?>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("MonthlyFinanceRecords");
                });
            ...
            modelBuilder.Entity("Models.ActivityLog", b =>
                {
                    b.HasOne("Models.AppUser", "Actee")
                        .WithMany()
                        .HasForeignKey("ActeeId");

                    b.HasOne("Models.AppUser", "Actor")
                        .WithMany()
