namespace Application.Utilities
{
    ...
    {
        public static readonly string CONNECTION_STRING = Environment.GetEnvironmentVariable("CONNECTION_STRING") ?? "host=host.docker.internal;port=5433;database=db;username=user;password=password;";
